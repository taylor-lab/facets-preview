                            ...
                            tabPanel("Segments (editable)",
                                     wellPanel(
                                       HTML(
                                         ...
                                         <u>Note:</u> This table is editable and 'Save Changes' button saves the edits to file ending with .cncf.edited.txt. This '.cncf.edited.txt' file (if exists) will be loaded automatically next time. (Only tcn/lcn/tcn.em/lcn.em are saved)</div><br>"
                                       ),
                                     ...
                                     #mainPanel(rHandsontableOutput("editableSegmentsTable"))),
